...
ifeq ($(TARGET_PREBUILT_KERNEL),)
	LOCAL_KERNEL := device/samsung/glide/prebuilt/kernel
else
...
PRODUCT_COPY_FILES += \
    ...
    device/samsung/glide/init.rc:root/init.rc \
...
PRODUCT_COPY_FILES += \
    ...
    device/samsung/glide/configs/media_codecs.xml:system/etc/media_codecs.xml

# Audio
PRODUCT_COPY_FILES += \
    device/samsung/glide/configs/audio_policy.conf:system/etc/audio_policy.conf
...
# Shell and busybox
PRODUCT_COPY_FILES += \
    device/samsung/glide/configs/bashrc:system/etc/bash/bashrc \
    device/samsung/glide/configs/mkshrc:system/etc/mkshrc \
